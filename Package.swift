...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "TelluricRenderExtraction", dependencies: ["TelluricCore", "TelluricDiagnostics", "TelluricMath", "TelluricRender", "TelluricRuntime", "TelluricWorld", "TelluricTerrain"]),
